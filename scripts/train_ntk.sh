CUDA_VISIBLE_DEVICES=0 python scripts/train_ntk.py --save_dir results_sdxl_ntk --cfg configs/sdxl_ntk_seed_123.yaml --ntk_lambda 0.1
...
# --save_dir results_sdxl_ntk/generated_images_flux_schnell_4steps_pruned_10/ \
