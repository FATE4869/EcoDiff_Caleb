...
HP_DIR = "results_flux_hp_search/flux_hp"
OUTPUT_DIR = "results_flux_hp_search/comparison"
PRUNED_SUBDIR = "pruned/pruned_10/pruned"
...
def short_label(exp_name):
    ...
    loss = next((parts[i+1] for i, p in enumerate(parts) if p == "loss"), "?")
